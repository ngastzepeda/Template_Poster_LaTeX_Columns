...
\author{
    \textbf{Homo Oeconomicus}, Universität Bielefeld, 
    \texttt{h.oec@uni-bielefeld.de}\\
    \textbf{Homo Oeconomicus II}, Universität Bielefeld, 
    \texttt{h.oec2@uni-bielefeld.de}
}
\abstract{%
...
The \texttt{department} option allows for the \texttt{economics, mathematics}
and \texttt{none} keys. The \texttt{institute} option currently only allows for
the \texttt{IMW} key. The \texttt{organization} option allows for the 
\texttt{BiGSEM, CUDE} and \texttt{SFB1283} keys.\\
The default options are the english economics department logo, the english IMW
logo and the CUDE logo without any text.\\
Section \ref{sec:implementation} contains notes on how to additional logos.
